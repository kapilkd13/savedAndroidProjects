 ...
 */
public class FAQLectureFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.faq_lecture_layout, container,false);

        if(savedInstanceState!=null)
        {isInstanceSaved=true;
            Log.v("loading img", "ailaa");
        ...
        switch (noImg){
            case 3:
                ...
                FindInDevice=new DownloadedFileAddress().getDownloadedFileAddress(Constants.IMAGE_NAME3,Constants.FAQ,id,getContext());
            ...
            case 2:
                FindInDevice=new DownloadedFileAddress().getDownloadedFileAddress(Constants.IMAGE_NAME2,Constants.FAQ,id,getContext());
                if(FindInDevice!=null) {
            ...
            case 1:
                FindInDevice=new DownloadedFileAddress().getDownloadedFileAddress(Constants.IMAGE_NAME1,Constants.FAQ,id,getContext());
                if(FindInDevice!=null) {
            ...
            case 1:
                ...
                playVideo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra("url",Constants.SERVER_FAQ_DIRECTORY_PATH);
                ...
                downloadVideo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        videolist.add(Constants.SERVER_FAQ_DIRECTORY_PATH);
...
//default video name is vid1.mp4
                        ...
                        videolist.add(new DownloadedFileAddress().getNewFileAddress(Constants.VIDEO_NAME, Constants.FAQ, id, getContext()));
                        //do this in service
    ...
    {
        return (Constants.SERVER_FAQ_DIRECTORY_PATH+Constants.PATH_DELIMETER+id+Constants.PATH_DELIMETER+filename);
    }
    ...
    {Bitmap thumb;
        String localaddress=new DownloadedFileAddress().getDownloadedFileAddress(Constants.VIDEO_NAME, Constants.FAQ, id, getContext());
