 ...
 */
public class UploadVideoInService extends Service {

    private static final String TAG = UploadVideoInService.class.getSimpleName();
    ...
    private class UploadFileToServer extends AsyncTask<ArrayList<String>, Integer, String> {
      ...
      private  int count=0;
        ...
        protected void onPreExecute() {
            ...
            mBuilder = new NotificationCompat.Builder(UploadVideoInService.this);
