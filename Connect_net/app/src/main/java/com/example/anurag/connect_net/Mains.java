...
public class Mains extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.showTimeline:
                String data=new InternalStorage().read(this,Constants.INTERNAL_STORAGE_TIMELINE_FILE);
